...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (email.toString() === "pulseadmin" && password.toString() === "pulseadmin") {
  ...
  return (
    <div style={{ backgroundColor: "#333", minHeight: "100vh" }}>
      <div className="w-full p-4 sm:p-12.5 xl:p-17.5 flex flex-col items-center">
        <Image
          className="dark:hidden mb-19" 
          src={"/images/logo/favicon.ico"}
          alt="Logo"
          width={176}
          height={32}
        />
        <h2 className="mb-20 text-2xl font-bold text-white dark:text-white sm:text-title-xl2 text-center">
          Bienvenue sur PulseAdmin
        </h2>
